...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "joined": "👾 <b>Joined the</b> <a href='https://t.me/zeferiot'>support chat</a>",
        "join": "👾 <b>Join the</b> <a href='https://t.me/zeferiot'>support chat</a>",
    }
    ...
    async def helpcmd(self, message: Message) -> None:
        ...
        for mod in self.allmodules.modules:
            ...
            if core:
                ...
                emoji = self.config['zeferio_emoji']
            else:
    ...
    async def supportcmd(self, message):
        ...
        if await self.allmodules.check_security(
            ...
            await self._client(JoinChannelRequest("https://t.me/zeferiot"))

            try:
                await self.inline.form(
                    self.strings("joined", message),
                    reply_markup=[
                        [{"text": "👩‍💼 Chat", "url": "https://t.me/zeferiot"}]
                    ],
                    ttl=10,
                    message=message,
                )
