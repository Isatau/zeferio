...
class InlineStuffMod(loader.Module):
    ...
    async def watcher(self, message: Message) -> None:
        if (
            ...
            or "Loading Zeferio gallery..." not in getattr(message, "raw_text", "")
        ):
            return
    ...
    async def ch_zeferio_botcmd(self, message: Message) -> None:
        """<username> - Change your Zeferio inline bot username"""
        ...
        self._db.set("zeferio.inline", "custom_bot", args)
