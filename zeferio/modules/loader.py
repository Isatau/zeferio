...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            "🚫 <b>This module requires Zeferio inline feature and "
        ...
        "version_incompatible": "🚫 <b>This module requires Zeferio {}+\nPlease, update with </b><code>.update</code>",
    ...
    async def load_module(
        ...
        if re.search(r"# ?scope: ?zeferio_min", doc):
            ver = re.search(
                r"# ?scope: ?zeferio_min ([0-9]+\.[0-9]+\.[0-9]+)",
                doc,
            ).group(1)
        ...
        module_name = "zeferio.modules." + uid
