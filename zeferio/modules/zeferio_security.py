...
@loader.tds
class ZeferioSecurityMod(loader.Module):
    """Control security settings"""

    strings = {
        "name": "ZeferioSecurity",
    ...
    async def client_ready(self, client, db) -> None:
        ...
        self._is_zeferio = hasattr(self, "inline")
    ...
    async def _add_to_group(
        ...
        if self._is_zeferio and not confirmed:
            await self.inline.form(
