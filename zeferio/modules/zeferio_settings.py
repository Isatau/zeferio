...
@loader.tds
class ZeferioSettingsMod(loader.Module):
    """Advanced settings for Zeferio Userbot"""

    strings = {
        "name": "ZeferioSettings",
        ...
        "inline_settings": "⚙️ <b>Here you can configure your Zeferio settings</b>",
    ...
    async def inline__setting(self, call: CallbackQuery, key: str, state: bool) -> None:
        ...
        if key == "no_nickname" and state and self._db.get(main.__name__, "command_prefix", ".") == ".":
            await call.answer("Warning! You enabled NoNick with default prefix! You may get muted in Zeferio chats. Change prefix or disable NoNick!", show_alert=True)
        else:
